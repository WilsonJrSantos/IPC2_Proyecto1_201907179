...
class Lista:
    ...
    def insertar_en_posicion(self, dato, posicion):
        ...
        contador = Contador(0, posicion - 1)
    ...
    def set_dato_en_posicion(self, posicion, dato):
        """
        Modifica el dato de un nodo en una posición específica de forma eficiente.
        """
        if posicion < 0 or posicion >= self.__tamaño:
            raise IndexError("Posición fuera de rango")
    ...
    def obtener_en_posicion(self, posicion):
        ...
        # Navegar hasta la posición usando un contador manual
        contador = 0
        while contador < posicion:
            actual = actual.get_siguiente()
            contador += 1
